...
class TestCell(unittest.TestCase):
    @ddt.idata([
        ('A1', '=XMATCH(1,{4.1,3,2.1,2,1},1,2)', {},
         "<Ranges>(A1)=[[1]]"),
        ('A1', '=XMATCH(-2,{"",4.1,"a",1.1},1,2)', {},
         "<Ranges>(A1)=[[1]]"),
        ('A1', '=XMATCH(4.1,{"","a",1.1,4.1},0,2)', {},
         "<Ranges>(A1)=[[#N/A]]"),
        ('A1', '=XMATCH(4.1,{"",4.1,"a",1.1},1,2)', {},
         "<Ranges>(A1)=[[2]]"),
        ('A1', '=XMATCH(1.1,{-1.1,2.1,3.1,4.1},1)', {},
         "<Ranges>(A1)=[[2]]"),
        ('A1', '=XMATCH(4.1,{1.1,4.1,"","a"},0,2)', {},
         "<Ranges>(A1)=[[2]]"),
        ('A1', '=XMATCH(4.1,{1.1,4.1,"","a"},0,-2)', {},
         "<Ranges>(A1)=[[2]]"),
        ('A1', '=XMATCH(4.1,{"","a",1.1,4.1},0,-2)', {},
        ...
        ('A1', '=XMATCH(A2,{-1.1,2.1,3.1,4.1},1)',
         {'A2': [[sh.EMPTY]]},
         "<Ranges>(A1)=[[#N/A]]"),
        ('A1', '=MATCH(1.1,{-1.1,2.1,3.1,4.1},1)', {},
         "<Ranges>(A1)=[[1]]"),
        ('A1', '=XMATCH("ss",{1,"SS","c bau c",4.1},0,2)', {},
         "<Ranges>(A1)=[[2]]"),
        ('A1', '=XLOOKUP(-2,{-1.1,2.1,3.1,4.1},{1,2,3,4}, "pippo")', {},
         "<Ranges>(A1)=[['pippo']]"),
        ('A1', '=XMATCH(0,{1,2,3,4,5},-1,2)', {},
         "<Ranges>(A1)=[[#N/A]]"),
        ('A1', '=XMATCH(3.5,{9,4.1,3,2.1,2},-1,-2)', {},
         "<Ranges>(A1)=[[3]]"),
        ('A1', '=XMATCH(5,{9,4.1,3,2.1,2},-1,-2)', {},
         "<Ranges>(A1)=[[2]]"),
        ...
        ('A1:A5', '=TREND({2;3;4;21;2},{2,1;2,2;5,3;2,4;4,1})', {},
         "<Ranges>(A1:A5)=[[2.1176470588235556]\n"
         " [7.352941176470604]\n"
         " [6.588235294117624]\n"
         " [17.8235294117647]\n"
         " [-1.882352941176464]]"),
        ...
        ('A1:B1', '=LINEST(A2:C2,A3:C3,0,0)',
         ...
         "<Ranges>(A1:B1)=[[1.0 0.0]]"),
        ('A1:C5', '=LINEST({2;3;4;21;2},{2,1;2,2;5,3;2,4;4,1},1,1)', {},
         "<Ranges>(A1:C5)=[[5.235294117647048 -2.0000000000000098 0.882352941176527]\n "
         "[7.194288391990419 1.7822655773580145 1.9331384382535273]\n "
         "[0.8112053142207846 5.041008302500836 #N/A]\n "
         "[2.8645061728395 2 #N/A]\n "
         "[218.37647058823484 50.82352941176471 #N/A]]"),
        ('A1:D5', '=LOGEST({2;3;4;21;2},{1,2,1;2,2,2;1,5,3;6,2,4;2,4,1},1,1)',
         {},
         "<Ranges>(A1:D5)=[[1.5659258509260767 0.9654962343041974 1.243497877058587\n  "
         "0.9790291254962936]\n "
         "[0.31095496747040535 0.08119886017046742 0.08470544656430365\n  "
         "0.11682066611763198]\n "
         "[0.9902997881386338 0.1918233037998577 #N/A #N/A]\n "
         "[25.522632966471217 1 #N/A #N/A]\n "
         "[3.75654157465267 0.0367961798806925 #N/A #N/A]]"),
        ('A1:C5', '=LINEST({2;3;4;21;2},{2,1;2,2;5,3;2,4;4,1},0,1)', {},
         "<Ranges>(A1:C5)=[[5.375451263537907 -1.8375451263537907 0.0]\n "
         "[0.9772930582193381 1.2778559569377042 #N/A]\n "
         "[0.8919709363432803 4.131415260871476 #N/A]\n "
         "[12.38515228426397 3 #N/A]\n "
         "[422.79422382671504 51.20577617328518 #N/A]]"),
        ('A1:D5', '=LOGEST({2;3;4;21;2},{1,2,1;2,2,2;1,5,3;6,2,4;2,4,1},0,1)',
         {},
         "<Ranges>(A1:D5)=[[1.5664334466775265 0.9610027927469469 1.2402383938034764 1.0]\n "
         "[0.05066588583718498 0.03537061734839379 0.08272771053197472 #N/A]\n "
         "[0.9972327485569291 0.13595424611813087 #N/A #N/A]\n "
         "[240.24626820088108 2 #N/A #N/A]\n "
         "[13.32181680404806 0.03696711407509861 #N/A #N/A]]"),
        ...
        ('A1', '=Z.TEST({0,-0.1,10,3.2},-0.9)', {},
         "<Ranges>(A1)=[[0.039007077373921395]]"),
        ...
        ('A1', '=F.TEST({0.1,0.9,3.2,0.7},{0.1,0.2,0.3,0.4})', {},
         "<Ranges>(A1)=[[0.0028587453134692044]]"),
        ('A1', '=F.TEST({0.1,0.9,3.2,0.7},{0.1,0.2;0.3,0.4})', {},
         "<Ranges>(A1)=[[0.0028587453134692044]]"),
        ('A1', '=F.TEST({0.1,0.9;3.2,0.7},{0.1,0.2,0.3,0.4})', {},
         "<Ranges>(A1)=[[0.0028587453134692044]]"),
